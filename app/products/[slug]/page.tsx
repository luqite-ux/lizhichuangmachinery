  ...
  return <div>
    ...
    <section className="border-b border-border"><div className="mx-auto grid max-w-7xl gap-9 px-4 py-12 md:grid-cols-[1fr_1.08fr] md:items-center md:px-6 md:py-16">
      ...
      <div className="grid gap-3">
        <div className="relative aspect-[16/10] overflow-hidden rounded-lg border border-border bg-white">{product.images[0] ? <Image src={product.images[0]} alt={`${product.model} ${product.name}`} fill priority sizes="(min-width: 768px) 50vw, 100vw" className="object-contain p-1.5 sm:p-2" /> : null}</div>
